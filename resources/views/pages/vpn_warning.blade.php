...
<html lang="en" dir="ltr">
	<head>
		...
		<!-- FAVICON -->
		<link rel="shortcut icon" type="image/x-icon" href="public/images/brand/favicon.ico" />
			...
			<div class="page-content error-page error2">
				<div class="container text-center">
					<div class="error-template">
						<h1 class="display-1 text-dark mb-2">VPN<span class="fs-20">belum diaktifkan</span></h1>
						<h5 class="error-details text-dark">
							Untuk mengakses web ini harus menggunakan VPN BPS
						</h5>
						<div class="text-center">
							<a class="btn btn-primary mt-5 mb-5" href="{{url('home')}}"> <i class="fa fa-long-arrow-left"></i> Back to Home </a>
						</div>
                    </div>
				</div>
			</div>

...
<head>
    ...
    <meta name="id-wilayah" content="{{Auth::user()}}">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body pb-2">
                                        ...
                                        <div id="info-sync" class="alert alert-primary fade show mb-4"
                                            role="alert">
                                            <strong>Info Message</strong>
                                            <hr class="message-inner-separator">
                                            <p id="info-message">Lakukan Synchronize terlebih dahulu untuk mendapatkan
                                        ...
                                        <div class="dimmer active text-center" id="loader-sipmen-api"
                                            ...
                                            <label class="text-center text-muted"> Mengambil nomor surat sipmen
                                                ...</label>
                                        </div>

                                        <div id="info-sync-api" style="display: none"
                                            class="alert alert-warning fade show mb-4" role="alert">
                                            <strong>Info Message</strong>
                                            <hr class="message-inner-separator">
                                            <p id="info-message">Nomor surat belum tersedia, belum ada surat yang
                                                diinput ke SIPMEN. Mohon melakukan input pada SIPMEN terlebih dahulu.
                                            </p>

                                        </div>

                                        <div class="row row-sm" id="container-surat-sipmen" style="display: none">
                                            <div class="form-group">
                                                <label class="form-label"> Pilih Nomor Surat</label>
                                                <select name="nomor_surat" id="input-nomor-surat"
                                                    ...
                                                    {{-- <option value="EX-001" prov="16" kab="02" kec="010" desa="001"
                                                        nbs="002B">EX-001</option>
                                                    <option value="EX-002" prov="16" kab="05" kec="071" desa="013"
                                                        nbs="006B">EX-002</option> --}}
                                            ...
                                            <div class="col-lg mg-t-10 mg-lg-t-0">
                                                ...
                                                <input id="input-kode-prov" name="kode_prov"
                                                    class="form-control mb-4" placeholder="Kode Prov" readonly=""
                                                    type="text">
                                            </div>
                                            <div class="col-lg mg-t-10 mg-lg-t-0">
                                                <label class="form-label"> KAB</label>
                                                <input id="input-kode-kab" name="kode_kab" class="form-control mb-4"
                                                    placeholder="Kode Kab" readonly="" type="text">
                                            </div>
                                            <div class="col-lg mg-t-10 mg-lg-t-0">
                                                <label class="form-label"> KEC</label>
                                                <input id="input-kode-kec" name="kode_kec" class="form-control mb-4"
                                                    placeholder="Kode Kec" readonly="" type="text">
                                            </div>
                                            <div class="col-lg mg-t-10 mg-lg-t-0">
                                                <label class="form-label"> DESA</label>
                                                <input id="input-kode-desa" name="kode_desa"
                                                    class="form-control mb-4" placeholder="Kode Desa" readonly=""
                                                    type="text">
                                            </div>
                                            <div class="col-lg mg-t-10 mg-lg-t-0">
                                                <label class="form-label"> BS</label>
                                                <input id="input-nbs" name="nbs" class="form-control mb-4"
                                                    placeholder="Kode BS" readonly="" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="info-input" class="alert alert-primary fade show mb-4"
                                            role="alert">
                                            <strong>Info Message</strong>
                                            <hr class="message-inner-separator">
                                            <p id="info-message">Pilih nomor surat terlbih dahulu untuk dapat melakukan
                                                input.
                                            </p>

                                        </div>

                                        <div class="dimmer active text-center" id="loader-sipmen-dsrt"
                                            style="display: none">
                                            <div class="spinner1-lg">
                                                <div class="double-bounce1"></div>
                                                <div class="double-bounce2"></div>
                                            </div>
                                            <label class="text-center text-muted"> Mengambil data DSRT
                                                ...</label>
                                        </div>

                                        <div class="row row-sm" id="container-input-dsrt" style="display: none">
                                            @csrf
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response['status'] == 'success' && response['data'].length > 0) {
                        // mounting select
                        var data_surat = response['data'];

                        data_surat.forEach(element => {
                            var option =
                                '<option value="' + element['no_surat_kirim_prop'] +
                                '" prov="' + element['kd_prop'] +
                                '" kab="'+element['kd_kab']+'" kec="' + element['kd_kec'] +
                                '" desa="' + element['kd_desa'] + '" nbs="' +
                                element['kd_sls'] + '">' + element[
                                    'no_surat_kirim_prop'] + ' -- [KEC:' +element[
                                    'kd_kec'] +' DESA:'+ element[
                                    'kd_kec']+ ' NBS:'+element['kd_sls']+'] </option>';
    ...
    $(document).ready(function() {
        $('#sync-sipmen-api').on('click', function() {
            ...
            $.ajax({
                ...
                url: "https://sipmen.bps.go.id/api1600/08",
                success: function(response) {
                    console.log(response);
...
<script>
    $(document).ready(function() {
        $('[name = "nomor_surat"]').on('change', function() {
